                ...
                <div className="flex flex-col w-full max-w-5xl mx-auto py-6 px-0 md:px-4 gap-4 md:gap-6">
                    {chatHistory.map((msg, index) => (
                        <div key={msg.id} className={`group w-full flex gap-3 md:gap-4 px-3 md:px-0 ${msg.role === 'user' ? 'justify-end' : 'justify-start'}`}>
                            {msg.role === 'assistant' && (
                                <div className="w-8 h-8 rounded-lg flex items-center justify-center flex-shrink-0 bg-gradient-to-br from-violet-600 to-indigo-600 mt-0.5 select-none text-white overflow-hidden shadow-lg shadow-violet-500/20">
