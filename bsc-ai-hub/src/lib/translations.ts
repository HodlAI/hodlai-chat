export const translations = {
  en: {
    ...
    config: {
      ...
      customApiKeyDesc: 'For standard users, just connect wallet. For developers, get key via /key in Telegram.',
  ...
  zh: {
    ...
    config: {
      ...
      language: '切换语言',
      languageLabel: '语言',
      customApiKey: '自定义 API 密钥 (可选)',
      customApiKeyDesc: '普通用户只需连接钱包。开发者可通过 TG 的 /key 获取。',
